...
|---|---|---|---|---|---|---|
| <m1-ten-feature> | M1 | mobile | DEV | in_progress | <YYYY-MM-DD> | [↗](m1-ten-feature/progress.md) |
...
- **Milestone:** M1 Nền tảng & kết nối lõi · M2 UI & Backend/Admin · M3 Tính năng nâng cao & bàn giao.
- **Phần:** mobile (RN CLI) · backend (NestJS+Supabase) · admin (web).
