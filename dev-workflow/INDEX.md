...
| m1-backend-user-mgmt | M1·C2 | backend | DEV | in_progress (B1–B3 code xong; **LIVE ✅ 2026-07-02** — cron/delete-jobs guard 401/200 + Prisma read OK; **`TUYA_APP_SCHEMA` verified**: `listUsers` → Tuya `success:true`, list rỗng (chưa user qua app custom, app chưa release). AC list-user thông) | 2026-07-02 | [↗](m1-backend-user-mgmt/progress.md) |
